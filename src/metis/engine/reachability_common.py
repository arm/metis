...
# â”€â”€ Graph builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
Source indicators â€” mark is_source=true when a function:
...
Sink indicators â€” mark is_sink=true when a function:
...
# â”€â”€ reachability confirmer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
interactions â€” where the focus file's functions are called, consumed, or depended \
...
# â”€â”€ supplementary analyzer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
4. ARRAY INDEX OUT OF BOUNDS: arr[flags & 0x0F] with arr[4] â€” mask allows 0-15.
...
# â”€â”€ pass 3: ownership / cleanup â”€â”€
...
5. ROLLBACK GAP: A function adds an entry to a data structure (rbtree, list, hash) then \
   fails a later step but does not remove the entry â€” leaving a dangling/corrupt entry.
...
# â”€â”€ pass 4: semantic / type / data-flow â”€â”€
...
5. FIELD STALENESS AFTER MUTATION: Data sanitized/transformed but old length/count stored â€” callers use stale value.
...
# â”€â”€ pass 5: state ordering and concurrency â”€â”€
...
4. LOCK ORDER INVERSION: Two or more locks are acquired in inconsistent orders across \
   different functions, creating deadlock potential. E.g. function A takes lock1â†’lock2 \
   but function B takes lock2â†’lock1.
...
class SupplementaryAnalyzer:
    ...
    # â”€â”€ cross-function passes (lifecycle, ownership, semantic, state) â”€â”€
...
# â”€â”€ deduplicator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
