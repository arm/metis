...
_CONFIRM_SYS = _confirm_system_prompt(
    """\
You are a security researcher analyzing source code.
You are given reachable call paths from graph sources to reachable endpoints, with relevant source code.
...
You are given:
- reachable call paths from graph sources
