...
from .history import write_history_records
...
def initialize_threat_model_memory(
    ...
    service = memory_service or config.memory_service
    if service is None:
        raise RuntimeError("Repository memory service is not configured")
